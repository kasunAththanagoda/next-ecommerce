...
export default function NavIcons() {
  ...
  return (
    <div className='flex items-center gap-4 xl:gap-6 relative'>
      ...
      <Image src='/cart.png' alt='' width={22} height={22} className='' onClick={()=>{setIsCartOpen((prev)=>!prev)}} />
      <div className='absolute -top-4 -right-4 w-6 bg-base rounded-full text-white text-sm flex items-center justify-center'>2</div>
      </div>
      {isCartOpen && (
        <CartModel></CartModel>
      )}
